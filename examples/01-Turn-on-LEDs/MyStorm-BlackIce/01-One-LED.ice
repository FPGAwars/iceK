  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f8f04887-1801-4db8-85c4-3def9bff5364",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "358cbcf1-7e1e-4dbe-8c1f-984ce3614ac7",
        ...
        {
          "id": "5d640722-babb-4fa8-81b0-7635716ce2ea",
        ...
        {
          "id": "0b1d5f4a-d002-4c8f-b214-0dfcba0ec32d",
          "type": "basic.info",
          "data": {
            "info": "Output pin",
            "readonly": true
        ...
        {
          "id": "d892c5e4-ce6e-428a-9af0-374dd55e4506",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "358cbcf1-7e1e-4dbe-8c1f-984ce3614ac7",
        ...
        {
          "source": {
            "block": "5d640722-babb-4fa8-81b0-7635716ce2ea",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "f8f04887-1801-4db8-85c4-3def9bff5364",
            "port": "in"
          }
        }
      ]
