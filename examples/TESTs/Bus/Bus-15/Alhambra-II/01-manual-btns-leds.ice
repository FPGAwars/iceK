{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 15-bits constant: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 240,
        ...
        {
          "id": "acf8d458-e34d-4ca8-98c2-491d29ec99b4",
          "type": "842788e2d76303db880877890459818efd552591",
          "position": {
            "x": 248,
            "y": 136
          },
        ...
        {
          "id": "e55707e7-f2d2-4ca0-b7a4-2703d6926b75",
          "type": "35ecd0bc82c4bbb1de2af54910b79c92e7604cdc",
          "position": {
            "x": 448,
            "y": 136
          },
        ...
        {
          "id": "fe96d051-bf58-4bc0-b087-4057fb0a722a",
        ...
        {
          "id": "f69dab23-0a0b-4b68-9653-6cb101e3711c",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "e55707e7-f2d2-4ca0-b7a4-2703d6926b75",
        ...
        {
          "source": {
            "block": "fe96d051-bf58-4bc0-b087-4057fb0a722a",
        ...
        },
        {
          ...
          "target": {
            "block": "acf8d458-e34d-4ca8-98c2-491d29ec99b4",
        ...
        },
        {
          ...
          "target": {
            "block": "e55707e7-f2d2-4ca0-b7a4-2703d6926b75",
            "port": "93f06007-9182-437e-9c52-1bcbb55131ed"
          },
          "size": 15
        },
        {
          "source": {
            "block": "e55707e7-f2d2-4ca0-b7a4-2703d6926b75",
            "port": "79912629-ec70-4ce4-9d01-b2db586e4c99"
          },
          "target": {
            "block": "fe96d051-bf58-4bc0-b087-4057fb0a722a",
        ...
        {
          "source": {
            "block": "f69dab23-0a0b-4b68-9653-6cb101e3711c",
  ...
  "dependencies": {
    ...
    "842788e2d76303db880877890459818efd552591": {
      "package": {
    ...
    "35ecd0bc82c4bbb1de2af54910b79c92e7604cdc": {
      "package": {
        "name": "Bus15-Split-7-8",
        "version": "0.1",
        "description": "Bus15-Split-7-8: Split the 15-bits bus into two buses of 7 and 8 wires",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M168.377%2077.643l61.147-60.938C240.21%206.25%20254.56.461%20269.484.5h62.611v26.186l-61.698.046c-8.012-.043-15.705%203.133-21.47%208.81L187.48%2096.857a57.292%2057.292%200%200%201-39.993%2016.139%2057.292%2057.292%200%200%201%2039.993%2016.14l61.448%2061.314c5.765%205.677%2013.458%208.853%2021.47%208.81l61.698.046v26.186h-62.612c-14.924.039-29.463-5.9-40.204-16.28l-60.902-60.863a29.857%2029.857%200%200%200-21.347-8.81L.5%20139.427V86.457h146.524a29.884%2029.884%200%200%200%2021.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "79912629-ec70-4ce4-9d01-b2db586e4c99",
              "type": "basic.output",
              "data": {
                "name": "1",
                "range": "[6:0]",
            ...
            {
              "id": "93f06007-9182-437e-9c52-1bcbb55131ed",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[14:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "93f06007-9182-437e-9c52-1bcbb55131ed",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            },
            {
              ...
              "target": {
                "block": "79912629-ec70-4ce4-9d01-b2db586e4c99",
                "port": "in"
              },
              "size": 7
            }
