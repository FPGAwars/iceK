{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "40728d0a-16b0-457a-8722-efa51696780e",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[6:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 7-bits Value 0: Test on LEDs\n\nShow the values on the LEDs",
            "readonly": true
          },
          "position": {
            "x": 448,
        ...
        {
          "id": "06309966-766c-4922-81e4-063c58efe429",
      ...
      "wires": [
        {
          "source": {
            "block": "06309966-766c-4922-81e4-063c58efe429",
            "port": "f6fbb4f1-1753-4354-a2c5-3299eef878f3"
          },
          "target": {
            "block": "40728d0a-16b0-457a-8722-efa51696780e",
            "port": "in"
          },
          "size": 7
        }
