{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 27-bits constant: Manual testing\n\n",
            "readonly": true
          },
          "position": {
            "x": 224,
        ...
        {
          "id": "e5564a0b-3b4b-4f28-98bf-5a3ee0d6f21e",
          "type": "22399aa70441e38bf89c7447a4da72a5da842036",
          "position": {
            "x": 248,
            "y": 152
          },
        ...
        {
          "id": "db05027f-6446-4960-a9d4-c02893bcdaa8",
          "type": "2ee6dfa9e460a54501cb0569c1ff2f6c7a671942",
          "position": {
            "x": 448,
            "y": 120
          },
        ...
        {
          "id": "1b816778-d1ec-4ef1-bf6e-04f00ef71e67",
        ...
        {
          "id": "da242a11-0b71-4a38-a5c9-6e5e0c7db85e",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "e5564a0b-3b4b-4f28-98bf-5a3ee0d6f21e",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          }
        },
        {
          "source": {
            "block": "db05027f-6446-4960-a9d4-c02893bcdaa8",
        ...
        },
        {
          ...
          "target": {
            "block": "db05027f-6446-4960-a9d4-c02893bcdaa8",
            "port": "33845b85-9d56-4533-b4e7-289b952a8378"
          },
          "size": 27
        },
        {
        ...
        },
        {
          "source": {
            "block": "db05027f-6446-4960-a9d4-c02893bcdaa8",
            "port": "a3a89abb-18c3-4249-a758-a01bec0afdff"
          },
          "target": {
            "block": "1b816778-d1ec-4ef1-bf6e-04f00ef71e67",
        ...
        {
          "source": {
            "block": "da242a11-0b71-4a38-a5c9-6e5e0c7db85e",
  ...
  "dependencies": {
    ...
    "22399aa70441e38bf89c7447a4da72a5da842036": {
      "package": {
    ...
    "2ee6dfa9e460a54501cb0569c1ff2f6c7a671942": {
      "package": {
        "name": "Bus27-Split-3-8-8-8",
        "version": "0.1",
        "description": "Bus27-Split-3-8-8-8: Split the 27-bits bus into four buses of 3, 8, 8 and 8 wires",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M168.377%2077.643l61.147-60.938C240.21%206.25%20254.56.461%20269.484.5h62.611v26.186l-61.698.046c-8.012-.043-15.705%203.133-21.47%208.81L187.48%2096.857a57.292%2057.292%200%200%201-39.993%2016.139%2057.292%2057.292%200%200%201%2039.993%2016.14l61.448%2061.314c5.765%205.677%2013.458%208.853%2021.47%208.81l61.698.046v26.186h-62.612c-14.924.039-29.463-5.9-40.204-16.28l-60.902-60.863a29.857%2029.857%200%200%200-21.347-8.81L.5%20139.427V86.457h146.524a29.884%2029.884%200%200%200%2021.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "a3a89abb-18c3-4249-a758-a01bec0afdff",
              "type": "basic.output",
              "data": {
                "name": "3",
                "range": "[2:0]",
            ...
            {
              "id": "33845b85-9d56-4533-b4e7-289b952a8378",
              "type": "basic.input",
              "data": {
                "name": "",
                "range": "[26:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "33845b85-9d56-4533-b4e7-289b952a8378",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            },
            {
              ...
              "target": {
                "block": "a3a89abb-18c3-4249-a758-a01bec0afdff",
                "port": "in"
              },
              "size": 3
            }
