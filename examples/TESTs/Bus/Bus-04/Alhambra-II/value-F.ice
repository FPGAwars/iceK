{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e3c5c2e9-5719-4dee-a397-37189e30fbb0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 4-bits Value 15: Test on LEDs\n\nShow the values on the LEDs",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        {
          "id": "d88063c9-014e-421a-84db-371d86fc5988",
      ...
      "wires": [
        {
          "source": {
            "block": "d88063c9-014e-421a-84db-371d86fc5988",
            "port": "bc11ba08-38a3-4e7a-a9c6-1ffd587e89f0"
          },
          "target": {
            "block": "e3c5c2e9-5719-4dee-a397-37189e30fbb0",
            "port": "in"
          },
          "size": 4
        }
