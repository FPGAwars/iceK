{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a2012435-fb17-4f66-b1cb-f197562f83a3",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[5:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 6-bits Value 0: Test on LEDs\n\nShow the values on the LEDs",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        {
          "id": "3eb972be-8a48-4fd5-b93b-6ae769fed0a0",
      ...
      "wires": [
        {
          "source": {
            "block": "3eb972be-8a48-4fd5-b93b-6ae769fed0a0",
            "port": "72bdb170-f2b3-4c77-a258-db39a7bef38d"
          },
          "target": {
            "block": "a2012435-fb17-4f66-b1cb-f197562f83a3",
            "port": "in"
          },
          "size": 6
        }
