{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "c4811666-8a06-4f35-af04-450169b03c61",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[4:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 5-bits Value 0: Test on LEDs\n\nShow the values on the LEDs",
            "readonly": true
          },
          "position": {
            "x": 512,
        ...
        {
          "id": "c58e3271-d5e5-4236-8854-94586915b4de",
      ...
      "wires": [
        {
          "source": {
            "block": "c58e3271-d5e5-4236-8854-94586915b4de",
            "port": "98e81f4b-d4eb-46c1-8750-25f681a5f2cf"
          },
          "target": {
            "block": "c4811666-8a06-4f35-af04-450169b03c61",
            "port": "in"
          },
          "size": 5
        }
