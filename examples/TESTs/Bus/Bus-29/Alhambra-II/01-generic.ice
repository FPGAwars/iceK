{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## 29-bits generic constant: Manual testing\n\nThe 29-bits constant is shown on the LEDs",
            "readonly": true
          },
          "position": {
            "x": 880,
        ...
        {
          "id": "24d86812-f998-4383-b5ca-b054dd2c3d63",
          "type": "bf79c6e225a72278076253c0681959b9fc49b63e",
          "position": {
            "x": 688,
            "y": 80
          },
        ...
        {
          "id": "b8eb2957-6fcb-40a6-8439-465c94b2b8ad",
        ...
        {
          "id": "d9cb1d45-8308-4241-8b42-af8c42361e7d",
          "type": "34e2b9e4be78d0224ff84e00f8d6f875e2f2d3bc",
          "position": {
            "x": 1040,
            "y": 64
          },
        ...
        {
          "id": "5dce9ec4-ca5f-4ee5-9d73-5ed7a69d32ca",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "24d86812-f998-4383-b5ca-b054dd2c3d63",
            "port": "c0fb4784-5e8c-4f41-9f4b-6daa2e9e03a4"
          }
        },
        {
          "source": {
            "block": "b8eb2957-6fcb-40a6-8439-465c94b2b8ad",
        ...
        },
        {
          "source": {
            "block": "24d86812-f998-4383-b5ca-b054dd2c3d63",
            "port": "f9393c27-2361-4418-86d6-c8dac99fcf79"
          },
          "target": {
            "block": "d9cb1d45-8308-4241-8b42-af8c42361e7d",
            "port": "c219eef3-56f1-44fa-82e8-bea875f0a347"
          },
          "size": 29
        },
        {
          "source": {
            "block": "5dce9ec4-ca5f-4ee5-9d73-5ed7a69d32ca",
            "port": "c176188b-a7f0-49d2-a549-6d5d429d427b"
          },
          "target": {
            "block": "d9cb1d45-8308-4241-8b42-af8c42361e7d",
            "port": "8dab1e46-8b9a-4283-8c1d-d15e3c35db77"
          },
          "vertices": [
            {
              "x": 976,
  ...
  "dependencies": {
    ...
    "bf79c6e225a72278076253c0681959b9fc49b63e": {
      "package": {
    ...
    "34e2b9e4be78d0224ff84e00f8d6f875e2f2d3bc": {
      "package": {
        "name": "Bus32-Join-3-29 CLONE",
        "version": "0.1",
        "description": "Bus32-Join-3-29: Join the two buses into an 32-bits Bus",
        "author": "Juan González-Gómez (Obijuan)",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22354.768%22%20height=%22241.058%22%20viewBox=%220%200%20332.59497%20225.99201%22%3E%3Cpath%20d=%22M164.218%2077.643L103.07%2016.705C92.386%206.25%2078.036.461%2063.11.5H.5v26.186l61.698.046c8.012-.043%2015.705%203.133%2021.47%208.81l61.448%2061.315a57.292%2057.292%200%200%200%2039.993%2016.139%2057.292%2057.292%200%200%200-39.993%2016.14L83.668%20190.45c-5.765%205.677-13.458%208.853-21.47%208.81L.5%20199.306v26.186h62.612c14.924.039%2029.463-5.9%2040.204-16.28l60.902-60.863a29.857%2029.857%200%200%201%2021.347-8.81l146.53-.113V86.457H185.571a29.884%2029.884%200%200%201-21.353-8.814z%22%20fill=%22green%22%20stroke=%22#000%22%20stroke-linecap=%22round%22%20stroke-linejoin=%22round%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "8dab1e46-8b9a-4283-8c1d-d15e3c35db77",
              "type": "basic.input",
              "data": {
                "name": "1",
                "range": "[2:0]",
            ...
            {
              "id": "c219eef3-56f1-44fa-82e8-bea875f0a347",
              "type": "basic.input",
              "data": {
                "name": "0",
                "range": "[28:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "c219eef3-56f1-44fa-82e8-bea875f0a347",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
            ...
            {
              "source": {
                "block": "8dab1e46-8b9a-4283-8c1d-d15e3c35db77",
                "port": "out"
              },
              "target": {
                "block": "16e78204-213e-4833-9096-89d735307ec2",
